...
function stopRain() {
    console.log('[Rain System] Stopping rain');
    isRaining = false;
    wetnessLevel = 0;
    rainParticles = [];
    rainSplashes = [];
...
function updateStage() {
    // Check for both stage 2 (level 1) and stage 3 (level 2)
    const newStage2 = playerLevel === 1;
    const enteringStage3 = playerLevel === 2;
    ...
    console.log('[Rain System] Checking stage:', {
        ...
        isRaining: isRaining,
        enteringStage3: enteringStage3
    });

    // If entering stage 3, stop the rain
    if (enteringStage3 && isRaining) {
        console.log('[Rain System] Entering stage 3, stopping rain');
        stopRain();
        isStage2 = false;
        return;
    }
    ...
    if (newStage2 !== isStage2) {
        ...
        if (isStage2) {
            ...
            // If leaving stage 2, stop the rain
            console.log('[Rain System] Leaving stage 2, stopping rain');
            stopRain();
        }
    }
}
...
function initRainSystem() {
    ...
    if (isStage2) {
        ...
        // If starting in stage 3, ensure rain is stopped
        console.log('[Rain System] Starting in stage 3, ensuring rain is stopped');
        stopRain();
    } else {
        console.log('[Rain System] Not in stage 2 or 3, rain not forced');
    }
}
