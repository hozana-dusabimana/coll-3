...
function initLevelInfos() {
    ...
    LI.sceneryListBias = 0.3;
    LI.groundColor = hsl(.2, .5, .7);
    LI.trackSideRate = 0;
    LI.billboardChance = 0;
    LI.bumpScaleMin = 1e3;
    LI.skyColorTop = hsl(.6, .9, .95);
    LI.skyColorBottom = hsl(.2, .7, .9);
    LI.cloudColor = hsl(.6, .9, 1, .9);
    LI.cloudHeight = .5;
    LI.cloudWidth = 1.4;
    LI.sunColor = hsl(.15, 1, 1);
    LI.sunHeight = .4;
    LI.horizonSprite = spriteList.horizon_mountains;
    LI.horizonSpriteSize = 2;
    LI.trafficDensity = 0;
    ...
    LI.bumpChance = 0;
    LI.waterSide = 1;
    LI.lineColor = hsl(.6, .8, 1, .3);
    LI.roadColor = hsl(.2, .4, .8);
